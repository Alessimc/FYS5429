...
def main(args):
    ...
    file_name = f"ELAN{args.model}_24h_batchsize{batch_size}_samples{nr_samples}_normalized{add_masked_loss}.pth"
    ...
    logger.info(f"Training ELAN{args.model} for a max of 24 hours with early stopping")
    ...
    with open(metrics_file, mode="w", newline="") as f:
        ...
        while True:
            ...
            for low_res, high_res in train_loader:
                ...
                low_res, high_res = low_res[:, :, 80:240, 80:240], high_res[:, :, 80:240, 80:240] # scale down
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Script to train ELAN Autoencoder.")
