#!/bin/bash -f                      
#$ -N train_transformer                    # Set the job name
...
python_script="/lustre/storeB/users/alessioc/FYS5429/transformer/train_transformer.py"


# Execute the Python script with arguments
python3 $python_script --model 1 --batch_size 8 --nr_samples 400
