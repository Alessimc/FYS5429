...
def main(args):
    ...
    add_masked_loss = "_masked_loss" if masked_loss else ""
    file_name = f"SwinIR_24h_batchsize{batch_size}_samples{nr_samples}_normalized{add_masked_loss}.pth"
    ...
    logger.info("Training SwinIR for a max of 24 hours with early stopping")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Script to train SwinIR.")
