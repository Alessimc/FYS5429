...
from srcnn_model import SRCNN, SRCNN2, SRCNN3, SRCNN4, SRCNN5, SRCNN6
import torch
...
def main(args):
    ...
    file_name = f"srcnn_model{args.model}_24h_batchsize{batch_size}_samples{nr_samples}_normalized.pth"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=int, required=True, choices=[1, 2, 3, 4, 5, 6], help="Choose model: 1, 2, 3, 4, 5 or 6.")
